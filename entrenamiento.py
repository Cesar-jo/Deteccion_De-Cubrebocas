...
dataPhat = "C:/Users/ternu/OneDrive/Escritorio/Redesneuronalespython/data"
...
face_mask.write("face_mask_model.xml") #escribimos el archivo donde se guardara el entrenamiento de los rostros
